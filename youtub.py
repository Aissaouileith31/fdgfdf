...
def youtub(page):
    page.padding = 1
    def go_to_ar_youtube(e):
        from arabic.youtube.youtube_ar import arabic_youtube
        page.controls.clear()
        arabic_youtube(page)
        page.update()
    ...
    first_frame = ft.Row([
        ft.Container(
            content=ft.Column([
                ...
                ft.ElevatedButton(width=200,height=60,color='white',bgcolor='#F57C00',on_hover=animate_buttons,on_click=go_to_ar_youtube,content=ft.Row(controls=[ft.Image(src_base64=icons[2],width=50,height=50),ft.Text('Arabic',size=20,text_align=ft.TextAlign.CENTER,offset=ft.Offset(0,0))]))
    ...
    second_frame = ft.Row([
        ft.Container(
            content=ft.Column([
                ...
                ft.ElevatedButton(width=200,height=60,color='white',bgcolor='#388E3C',on_hover=animate_buttons,content=ft.Row(controls=[ft.Image(src_base64=icons[18],width=50,height=50),ft.Text('Math',size=20,text_align=ft.TextAlign.CENTER,offset=ft.Offset(0,0))]))
    ...
    therd_frame = ft.Row([
        ft.Container(
            content=ft.Column([
                ft.Text('lessons and summaries in:',color='white',weight='bold',size=33,text_align=ft.TextAlign.CENTER),
                ft.Text('sience',color='white',size=31,text_align=ft.TextAlign.CENTER),
                ft.ElevatedButton(width=200,height=60,color='white',bgcolor='#BA68C8',on_hover=animate_buttons,content=ft.Row(controls=[ft.Image(src_base64=icons[21],width=60,height=60),ft.Text('sience',size=20,text_align=ft.TextAlign.CENTER,offset=ft.Offset(0,0))]))
    ...
    def page_resaize(e):
        page.controls.clear()
        if page.width < 600:
            page.controls.append(ft.Column(controls=[first_frame,second_frame,therd_frame,fourth_frame,fifth_frame,six_frame,seven_frame,eghit_frame,nine_frame,ten_frame,eleven_frame,twelve_frame,thertine_frame,fourtine_frame,feftine_frame,sixtine_frame,seventine_frame,eghtine_frame,nintine_frame,tweni_frame]))
            page.add(ft.ElevatedButton(width=200,height=60,color='white',bgcolor='#8A0000',on_hover=animate_buttons,on_click=go_to_home,content=ft.Text('Back',size=20,text_align=ft.TextAlign.CENTER)))
        else:
